...
class TestVirtualRouterApiDiscovery(ThriftInterface):
    EXPECTED_FUNCTIONS = [
    ...
    EXPECTED_ATTR_PREFIXES = ["SAI_VIRTUAL_ROUTER_ATTR_"]

    def runTest(self):
        discovered = {n for n, _ in get_sai_api_functions("_virtual_router")}
