...
class TestNextHopGroupApiDiscovery(ThriftInterface):
    EXPECTED_FUNCTIONS = [
    ...
    EXPECTED_ATTR_PREFIXES = [
        "SAI_NEXT_HOP_GROUP_ATTR_",
        "SAI_NEXT_HOP_GROUP_MEMBER_ATTR_",
    ]

    def runTest(self):
        discovered = {n for n, _ in get_sai_api_functions("_next_hop_group")}
