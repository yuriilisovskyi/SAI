...
class TestRouterInterfaceApiDiscovery(ThriftInterface):
    EXPECTED_FUNCTIONS = [
    ...
    EXPECTED_ATTR_PREFIXES = ["SAI_ROUTER_INTERFACE_ATTR_"]

    def runTest(self):
        discovered = {n for n, _ in get_sai_api_functions("_router_interface")}
